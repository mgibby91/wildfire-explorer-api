...
const rowToFireFeature = (
  ...
  return {
    ...
    properties: {
      ...
      ...(row.fire_date_start !== undefined && {
        fire_date_start: (row.fire_date_start as Date) ?? null,
      }),
      ...(row.fire_date_end !== undefined && {
        fire_date_end: (row.fire_date_end as Date) ?? null,
      }),
